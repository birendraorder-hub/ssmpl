  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <img src={heroImage} alt="Professional Security Services" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-overlay"></div>
        </div>
        
        <div className="container mx-auto px-4 z-10 relative">
          <div className="max-w-3xl animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">Professional Security and Housekeeping Solutions for a Safer, Cleaner India</h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">Solution Security Management Pvt. Ltd. (SSMPL) is a Bhubaneswar-based company providing professional security and housekeeping manpower. Serving Odisha with excellence, moving towards a pan-India presence.</p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6">Your Trusted Security Partner </h2>
            ...
            <div className="flex flex-wrap justify-center gap-6 text-left">
              {["Trained & Verified Personnel", "Statewide Coverage Across Odisha", "PSARA Compliance & Certification", "24×7 Professional Supervision"].map((item, index) => <div key={index} className="flex items-center space-x-2">
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((highlight, index) => <Card key={index} className="border-none shadow-medium hover:shadow-strong transition-all duration-300 hover:-translate-y-2 animate-scale-in">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => <Card key={index} className="overflow-hidden border-none shadow-medium hover:shadow-strong transition-all duration-300 group">
